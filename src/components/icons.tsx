...
export const Building2: React.FC<IconProps> = ({ className }) => (
...
export const SlidersHorizontal: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <line x1="21" y1="16" x2="13" y2="16" />
    <line x1="9" y1="16" x2="3" y2="16" />
    <line x1="21" y1="4" x2="15" y2="4" />
    <line x1="11" y1="4" x2="3" y2="4" />
...
export const ArrowDownRight: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M17 17V7H7" />
        <path d="m17 17-10-10" />
    </svg>
...
export const ClipboardCheck: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
